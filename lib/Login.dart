  ...
  void _checkLogin(){
    if(user != ''  &&  pass != ''){
      if(user == 'user' && pass == '123'){
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Enter valid"),));
      }
    }else{
       ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Please enter ")));
    }
  }
